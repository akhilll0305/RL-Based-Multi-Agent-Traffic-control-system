...
def plot_training_curves(history_csv='outputs/results/single/training_history.csv'):
    ...
    plt.tight_layout()
    plt.savefig('outputs/results/single/training_curves.png', dpi=300)
...
def plot_comparison(ddqn_results, fixed_results, random_results):
    ...
    plt.tight_layout()
    plt.savefig('outputs/results/single/comparison.png', dpi=300)
