...
from traffic_rl.sumo_gen.single import generate_all_sumo_files
...
def create_directories():
    ...
    directories = ['outputs/checkpoints/single', 'outputs/models', 'outputs/results/single', 'sumo_files/single', 'logs']
...
def main(args):
    ...
    if not os.path.exists('sumo_files/single/intersection.net.xml'):
    ...
    if args.mode == 'train' or args.mode == 'all':
        ...
        env = SumoEnvironment(
            ...
            route_file='sumo_files/single/routes.rou.xml',
            use_gui=False,
            num_seconds=3600,
            delta_time=5
        )
        ...
        # Save final model
        agent.save('outputs/models/ddqn_traffic_final.pth')
        print("\nFinal model saved to models/ddqn_traffic_final.pth")
        
        # Plot training curves
        plot_training_curves('outputs/results/single/training_history.csv')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model-path', type=str, default='outputs/models/ddqn_traffic_final.pth',
