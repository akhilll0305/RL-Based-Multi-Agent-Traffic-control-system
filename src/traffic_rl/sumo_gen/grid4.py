...
"""
    ...
    with open('sumo_files/grid4/multiagent.nod.xml', 'w') as f:
        f.write(nodes_xml)
...
"""
    ...
    with open('sumo_files/grid4/multiagent.edg.xml', 'w') as f:
        f.write(edges_xml)
...
"""
    ...
    with open('sumo_files/grid4/multiagent.tls.xml', 'w') as f:
        f.write(tls_xml)
...
"""
    ...
    with open('sumo_files/grid4/multiagent.rou.xml', 'w') as f:
        f.write(routes_xml)
...
"""
    ...
    with open('sumo_files/grid4/multiagent.sumocfg', 'w') as f:
        f.write(cfg_xml)
...
def generate_all():
    ...
    # Create directory
    os.makedirs('sumo_files/grid4', exist_ok=True)
